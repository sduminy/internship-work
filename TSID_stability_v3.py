...
invdyn.addMotionTask(FRfootTask, w_foot, 0, 0.0)
...
err_xFRpos = FR_foot_goal.translation[0,0] - xFRpos
err_yFRpos = FR_foot_goal.translation[1,0] - yFRpos
err_zFRpos = FR_foot_goal.translation[2,0] - zFRpos

plt.figure(1)
plt.plot(ts, xFRpos, label='position along x-axis')
plt.plot(ts, yFRpos, label='position along y-axis')
plt.plot(ts, zFRpos, label='position along z-axis')
plt.grid()
plt.title('Position of the FR foot function of time')
plt.legend()

plt.figure(2)
plt.plot(ts, err_xFRpos, label='position error along x-axis')
plt.plot(ts, err_yFRpos, label='position error along y-axis')
plt.plot(ts, err_zFRpos, label='position error along z-axis')
plt.grid()
plt.title('Position errors of the FR foot function of time')
plt.legend()
